...
namespace TatBlog.Data.Seeders
{
    public class DataSeeder : IDataSeeder
    {
        ...
        private IList<Author> AddAuthors()
        {
            ...
            {
                new() { FullName = "Nguyen Van A", UrlSlug = "nguyen-van-a", Email = "a@example.com", ImageUrl = "/images/a.jpg", JoinedDate = DateTime.Now.AddMonths(-12), Notes = "Backend expert" },
                new() { FullName = "Tran Thi B", UrlSlug = "tran-thi-b", Email = "b@example.com", ImageUrl = "/images/b.jpg", JoinedDate = DateTime.Now.AddMonths(-10), Notes = "Frontend wizard" },
                new() { FullName = "Le Van C", UrlSlug = "le-van-c", Email = "c@example.com", ImageUrl = "/images/c.jpg", JoinedDate = DateTime.Now.AddMonths(-8), Notes = "Fullstack developer" },
                new() { FullName = "Pham Thi D", UrlSlug = "pham-thi-d", Email = "d@example.com", ImageUrl = "/images/d.jpg", JoinedDate = DateTime.Now.AddMonths(-6), Notes = "DevOps engineer" },
                new() { FullName = "Hoang Van E", UrlSlug = "hoang-van-e", Email = "e@example.com", ImageUrl = "/images/e.jpg", JoinedDate = DateTime.Now.AddMonths(-4), Notes = "Cloud architect" }
            };
